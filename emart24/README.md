...
> ⚠️ **DEPRECATED 경로** — 이 디렉터리는 **2026-04-30 시점의 정적 스냅샷**이며 더 이상 갱신되지 않습니다.
>
> 최신 데이터는 **[`convenience/emart24/`](../convenience/emart24/)** 를 참조하세요. 매주 월요일 03:00 KST 자동 갱신됩니다.
>
> Raw URL:
> - `https://raw.githubusercontent.com/itda-skills/data-retail/main/convenience/emart24/_latest.csv`
> - `https://raw.githubusercontent.com/itda-skills/data-retail/main/convenience/emart24/{YYYY}/{MM}.csv`
>
> 이 디렉터리는 옛 경로(`emart24/...`)를 참조하는 외부 가이드·AI 컨텍스트의 점진적 마이그레이션을 위해 보존되며, 외부 참조가 정리된 시점에 일괄 삭제될 예정입니다.
